...
namespace EventStore.Core.XUnit.Tests.Scavenge {
	public class ScavengeCheckpointTests {
		private T RoundTrip<T>(T input, string expectedJson) where T : ScavengeCheckpoint {
			...
			Assert.Equal(input.ScavengePoint.UpToPosition, deserialized.ScavengePoint.UpToPosition);
		...
		[Theory]
		[InlineData(null, @"{""scavengePoint"":{""upToPosition"":1234,""eventNumber"":5,""effectiveNow"":""2022-01-05T00:00:00"",""threshold"":567},""schemaVersion"":""V0"",""checkpointStage"":""Accumulating""}")]
		[InlineData(5, @"{""scavengePoint"":{""upToPosition"":1234,""eventNumber"":5,""effectiveNow"":""2022-01-05T00:00:00"",""threshold"":567},""schemaVersion"":""V0"",""checkpointStage"":""Accumulating"",""doneLogicalChunkNumber"":5}")]
		...
		public void can_round_trip_calculating_default() {
			var cp = RoundTrip(
				...
				@"{""scavengePoint"":{""upToPosition"":1234,""eventNumber"":5,""effectiveNow"":""2022-01-05T00:00:00"",""threshold"":567},""schemaVersion"":""V0"",""checkpointStage"":""Calculating""}");
		...
		[Theory]
		[InlineData(null, @"{""scavengePoint"":{""upToPosition"":1234,""eventNumber"":5,""effectiveNow"":""2022-01-05T00:00:00"",""threshold"":567},""schemaVersion"":""V0"",""checkpointStage"":""ExecutingChunks""}")]
		[InlineData(5, @"{""scavengePoint"":{""upToPosition"":1234,""eventNumber"":5,""effectiveNow"":""2022-01-05T00:00:00"",""threshold"":567},""schemaVersion"":""V0"",""checkpointStage"":""ExecutingChunks"",""doneLogicalChunkNumber"":5}")]
		...
		public void can_round_trip_executing_index() {
			var cp = RoundTrip(
				...
				@"{""scavengePoint"":{""upToPosition"":1234,""eventNumber"":5,""effectiveNow"":""2022-01-05T00:00:00"",""threshold"":567},""schemaVersion"":""V0"",""checkpointStage"":""ExecutingIndex""}");
			//qq Assert.Equal();
		}
		...
		public void can_round_trip_done() {
			var cp = RoundTrip(
				...
				@"{""scavengePoint"":{""upToPosition"":1234,""eventNumber"":5,""effectiveNow"":""2022-01-05T00:00:00"",""threshold"":567},""schemaVersion"":""V0"",""checkpointStage"":""Done""}");
		}
