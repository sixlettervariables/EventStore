...
namespace EventStore.Core.XUnit.Tests.Scavenge {
	public class ScavengeCheckpointTests {
		...
		[Theory]
		[InlineData(null, @"{""scavengePoint"":{""position"":1234,""effectiveNow"":""2022-01-05T00:00:00""},""schemaVersion"":""V0"",""checkpointStage"":""Accumulating""}")]
		[InlineData(5, @"{""scavengePoint"":{""position"":1234,""effectiveNow"":""2022-01-05T00:00:00""},""schemaVersion"":""V0"",""checkpointStage"":""Accumulating"",""doneLogicalChunkNumber"":5}")]
		...
		public void can_round_trip_calculating_default() {
			var cp = RoundTrip(
				...
				@"{""scavengePoint"":{""position"":1234,""effectiveNow"":""2022-01-05T00:00:00""},""schemaVersion"":""V0"",""checkpointStage"":""Calculating""}");
		...
		[Theory]
		[InlineData(null, @"{""scavengePoint"":{""position"":1234,""effectiveNow"":""2022-01-05T00:00:00""},""schemaVersion"":""V0"",""checkpointStage"":""ExecutingChunks""}")]
		[InlineData(5, @"{""scavengePoint"":{""position"":1234,""effectiveNow"":""2022-01-05T00:00:00""},""schemaVersion"":""V0"",""checkpointStage"":""ExecutingChunks"",""doneLogicalChunkNumber"":5}")]
		...
		public void can_round_trip_executing_index() {
			var cp = RoundTrip(
				...
				@"{""scavengePoint"":{""position"":1234,""effectiveNow"":""2022-01-05T00:00:00""},""schemaVersion"":""V0"",""checkpointStage"":""ExecutingIndex""}");
			//qq Assert.Equal();
		}
		...
		public void can_round_trip_done() {
			var cp = RoundTrip(
				...
				@"{""scavengePoint"":{""position"":1234,""effectiveNow"":""2022-01-05T00:00:00""},""schemaVersion"":""V0"",""checkpointStage"":""Done""}");
		}
